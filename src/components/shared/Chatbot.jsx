          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    <div className="mt-auto mb-1">
                      <div
                        className={`w-8 h-8 rounded-full flex items-center justify-center text-xs ${msg.role === 'user' ? 'bg-primary text-primary-content' : 'bg-base-300 text-base-content'}`}
                      >
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span
                        className={`text-[10px] opacity-50 ${msg.role === 'user' ? 'text-right' : 'text-left'}`}
                      >
                        {msg.time}
                      </span>
                    </div>
            ...
            <div className="p-3 bg-base-100 border-t border-base-300">
              <form onSubmit={handleSendMessage} className="flex gap-2">
                ...
                >
                  <FaPaperPlane
                    className={`group-hover:scale-110 transition-transform ${!inputMessage.trim() || isTyping ? 'opacity-50' : ''}`}
                  />
                </button>
              </form>
            </div>

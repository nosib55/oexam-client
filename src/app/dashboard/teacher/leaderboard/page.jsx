    ...
    <div className="max-w-5xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-extrabold text-gray-800 flex items-center justify-center gap-3">
          <Trophy className="text-[#004aad] w-10 h-10" /> Academic Leaderboard
        </h1>
      ...
      <div className="relative mb-6 max-w-md mx-auto">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#004aad] outline-none transition-all"
